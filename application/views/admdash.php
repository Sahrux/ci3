...
<head>
    ...
    <!-- <link rel="stylesheet" href="admdash.css"> -->
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#editEmployeeModal" class="edit" id="<?php echo $row->id;?>" data-toggle="modal"onclick="getId(this.id)"> <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                        <a  href="#deleteEmployeeModal" id="<?php echo $row->id;?>" class="delete" data-toggle="modal" onclick="getId(this.id)"><i class="material-icons" data-toggle="tooltip"  title="Delete">&#xE872;</i></a>
